...
export function TaskPanel() {
  ...
  return <section className="task-section panel"><div className="task-header"><div className="section-heading"><span>MD</span><div><h2>手動產圖備援</h2><p>{project.generationProvider === 'chatgpt' ? 'ChatGPT' : 'Gemini'} · 自動 API 不可用時使用</p></div></div>
    ...
    <div className="task-actions"><button className="primary-button" onClick={() => void create()}>下載完整產圖 MD</button><span>自動產圖為主要流程；只有需要人工到平台微調時才下載 MD，並與 {project.referencePhotos.length} 張照片同次上傳</span></div>
